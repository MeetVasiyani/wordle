...
function showPlayAgainButton() {
  setTimeout(() => {
    let playAgainButton = document.querySelector("[data-play-again]")
    if (!playAgainButton) {
      playAgainButton = document.createElement("button")
      playAgainButton.innerText = "Play Again"
      playAgainButton.classList.add("play-again-button")
      playAgainButton.setAttribute("data-play-again", "")
      ...
      document.querySelector("[data-overlay]").style.display = "block"
    }
  }, 1500)
}
...
document.addEventListener('DOMContentLoaded', function() {
  if (!localStorage.getItem('wordleVisited')) {
...
function initializeModal() {
  ...
  closeButton.addEventListener("click", hideHowToPlay);
